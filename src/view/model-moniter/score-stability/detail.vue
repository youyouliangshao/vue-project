			...
			<div class="el-row" style="position: relative;">
				...
				<el-row>
					<el-col :span="24"class="mt5">
						<p>注意！<span class="c-red">{{modelDtoList.exceptionNum}}</span>个评分等级出现异常：
    ...
    export default {
        ...
        methods: {
            ...
            exportModelStability(){
				window.location.href=api.modelMoniter.getScoreDetailDownLoad(this.formData.modelName);
            },
	        //setModelStability
            setModelStability(){
                var pushParams={
	        ...
	        getMoniterDetail(){
                api.modelMoniter.getMoniterDetaiById({paramType:this.formData.paramType,riskModelId:this.formData.modelName}).then(result => {
                    ...
                    console.log( this.modelDtoList.scoreCardStabilityDtoList)
